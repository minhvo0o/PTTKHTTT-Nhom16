...
namespace PTTKHTTT
{
    public partial class traCuuPhieuDKTiem : Form
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                using(DataTable dt = new DataTable("PHIEUDANGKYTIEMCHUNG"))
                {
        ...
        private void lsTiem_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            capNhatPhieuDKTiem.instance.dateTiem.Text = Convert.ToDateTime(lsTiem.Rows[i].Cells[4].Value).ToShortDateString();
